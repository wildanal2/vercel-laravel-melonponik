...
<body class="bg-gray-50">
    ...
    <section class="py-16 px-8 min-h-[70vh] flex items-center">
        <div class="max-w-2xl mx-auto text-center">
            ...
            <h1 class="text-9xl font-bold text-purple-500 mb-4">419</h1>
            <h2 class="text-3xl font-bold text-gray-800 mb-4">Sesi Telah Berakhir</h2>
            <p class="text-gray-600 mb-8">Sesi Anda telah berakhir. Silakan muat ulang halaman dan coba lagi.</p>
